...
// Call the stored procedure to fetch payment data
$result = mysqli_query($conn, "CALL fetch_payment_data()");

// Check if the call was successful
if ($result !== false) {
    // Fetch the result and display it in the HTML table
    $nums = mysqli_num_rows($result); // Get the number of rows
}
?>
